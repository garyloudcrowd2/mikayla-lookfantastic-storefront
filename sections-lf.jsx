    ...
    <section className="signature">
      <div className="sig-portrait">
        ...
        <div className="sig-portrait-cap">
          <div className="sig-portrait-eye">ON HANNAH TODAY</div>
      ...
      <div className="sig-side">
        ...
        <p className="section-sub">"If I had to walk into a 6am call time with a single black case, this is what's in it." — Hannah</p>
  ...
  return (
    <section className="shopgrid">
      <div className="section-head">
        <div className="section-eye">CHAPTER 03 · HANNAH'S FULL KIT</div>
      ...
      <div className="sg-filters">
        ...
        <div className="sg-sort">Sort: Hannah's pick order ↓</div>
      </div>
...
const Edits = () => (
  <section className="edits">
    <div className="section-head">
      ...
      <h2 className="section-title">Curated for the moment. <em>Curated by Hannah.</em></h2>
    </div>
        ...
        <article key={i} className="review-card">
          ...
          <div className="rev-foot">
            <div>
              ...
              <div className="rev-date">{r.date} · Bought via Hannah's storefront</div>
            </div>
...
const Footer = () => (
  <footer className="storefront-footer">
    <div className="sf-cta">
      <div className="sf-eye">LOOKFANTASTIC × HANNAH RENÉE</div>
      <h2 className="sf-h">Shop her storefront <em>or book her.</em></h2>
      <div className="sf-actions">
        <button className="btn-pri">Shop the full kit</button>
        <button className="btn-sec-l">Follow on LookFantastic →</button>
        <button className="btn-sec-l">Book Hannah for an event</button>
      </div>
    </div>
    <div className="sf-base">
      <span>© 2026 LookFantastic USA, Inc.</span>
      <span>·</span>
      <span>Storefront powered by creator program</span>
      <span>·</span>
      <a href="#">Become a LookFantastic creator</a>
    </div>
  </footer>
);
