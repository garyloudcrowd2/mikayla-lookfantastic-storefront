// LookFantastic chrome — minimal black header that anchors the page to sephora.com
const LookFantasticChrome = () => (
  <header className="sephora-chrome">
    <div className="sc-row">
      <div className="sc-left">
        ...
        <a className="sc-logo" href="#">LOOKFANTASTIC</a>
      </div>
...
window.LookFantasticChrome = LookFantasticChrome;
