      ...
      <div className="rm-stage rm-stage-timeline">
        ...
        <div className="rm-side">
          <div className="rm-side-head">
            ...
            <div className="rm-side-title">As Hannah applies →</div>
          </div>
        ...
        <div className="rm-video rm-video-tall" onClick={() => setPaused(!paused)}>
          ...
          {!paused && (
            <div className="rm-tap-hint">
              ...
              <span className="rm-tap-hint-sub">→ shop what Hannah's wearing</span>
            </div>
          )}
          {paused && hs.map(h => (
  ...
  return (
    <section className="reels">
      <div className="section-head">
        ...
        <p className="section-sub">Tap any reel to open Hannah's masterclass. Explore products as she applies them.</p>
      </div>
